package com.cankarademir.cankarademir_odev7.adapter
...
import com.cankarademir.cankarademir_odev7.R
...
class NoteAdapter(): RecyclerView.Adapter<NoteAdapter.NoteViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int) = NoteViewHolder(
        LayoutInflater.from(parent.context).inflate(R.layout.card_item_notes, parent, false)
    )
